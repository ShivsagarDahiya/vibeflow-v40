      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold active:scale-95 transition-transform ml-auto"
            style={{
              background: "oklch(0.20 0.018 15)",
              border: "1px solid oklch(0.28 0.020 15)",
              color: "oklch(0.78 0.14 75)",
            }}
            data-ocid="match.filter.button"
          >
            <Filter size={12} />
            Filter
          </button>
      ...
      <AnimatePresence>
        {showFilterSheet && (
          ...
          >
            ...
            />
            <motion.div
              className="relative w-full rounded-t-3xl px-5 pt-4 pb-10 z-10 max-h-[80vh] overflow-y-auto"
            ...
            >
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <button
                  ...
                  style={{ background: "oklch(0.20 0.018 15)" }}
                >
                  <X size={15} style={{ color: "oklch(0.60 0.010 15)" }} />
                </button>
              </div>
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <input
                  ...
                  data-ocid="match.filter.age_range"
                />
                <span
                  className="text-sm"
                  style={{ color: "oklch(0.94 0.008 60)" }}
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <input
                  ...
                  defaultValue={25}
                  className="flex-1 accent-rose-500"
                  data-ocid="match.filter.distance_range"
                />
                <span
                  className="text-sm"
                  style={{ color: "oklch(0.94 0.008 60)" }}
              ...
              <div className="flex gap-2 mb-5 flex-wrap">
                {["Everyone", "Men", "Women", "Non-binary"].map((g) => (
                  <button
                    key={g}
                    type="button"
                    ...
                    style={{
                      background:
                        g === "Everyone"
                          ? "oklch(0.65 0.22 10 / 0.15)"
                          : "transparent",
                      borderColor:
                        g === "Everyone"
                          ? "oklch(0.65 0.22 10 / 0.5)"
                          : "oklch(0.28 0.020 15)",
                      color:
                        g === "Everyone"
                          ? "oklch(0.65 0.22 10)"
                    ...
                    data-ocid={`match.filter.gender.${g.toLowerCase()}`}
                  >
                    {g}
                  </button>
                ))}
              ...
              {/* Has video */}
              <div
                className="flex items-center justify-between mb-5 p-3 rounded-2xl"
                style={{ background: "oklch(0.20 0.018 15)" }}
              >
                <span
                ...
                <div
                  ...
                  data-ocid="match.filter.has_video"
                >
              ...
              <button
                ...
                data-ocid="match.filter.apply.button"
              >
                Apply Filters
              </button>
            </motion.div>
