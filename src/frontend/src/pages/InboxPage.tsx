                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1 mt-0.5">
                          ...
                          >
                            {conv.lastMessageText?.startsWith("WEBRTC_SIGNAL::")
                              ? "📞 Missed call"
                              : conv.lastMessageText?.startsWith("VOICE::")
                                ? "🎤 Voice message"
                                : conv.lastMessageText?.startsWith("MEDIA::")
                                  ? "📎 Media"
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {conv.unreadCount > 0 && (
                          <div
                            className="min-w-[18px] h-[18px] rounded-full px-1 flex items-center justify-center text-[10px] font-bold text-white"
                            style={{ background: "oklch(0.65 0.22 10)" }}
                          >
                            {conv.unreadCount}
                          </div>
